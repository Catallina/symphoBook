...
import { BookDetailsActions, BookDetailsActionType } from '@syb/global/book-details/book-details.actions';
import { initialBookDetailsState } from '@syb/global/book-details/book-details.state';
...
export function bookDetailsReducer(
  ...
  switch (action.type) {
    ...
    case BookDetailsActionType.SEARCH_BOOK_SUCCESS: {
      return newState(state, {
          busy: true,
          searchBook: action.payload.bookList
      });
    }

    case BookDetailsActionType.SEARCH_BOOK_ERROR: {
      return newState(state, {
          busy: false,
      });
    }
    ...
    case BookDetailsActionType.SELECT_FILTER: {
      return newState(state, {
