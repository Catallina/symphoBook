...
export enum BookDetailsActionType {
  ...
  SEARCH_BOOK = '[BOOK][BookDetails] Search book',
  SEARCH_BOOK_SUCCESS = '[BOOK][BookDetails] Search book success',
  SEARCH_BOOK_ERROR = '[BOOK][BookDetails] Search book error',

  SELECT_FILTER = '[BOOK][BookDetails] Selected filter',
...
export class SearchBookAction implements Action {
  ...
  constructor(public payload: { filterType: string, query: string }) { }
}
export class SearchBookSuccessAction implements Action {
  readonly type = BookDetailsActionType.SEARCH_BOOK_SUCCESS;

  constructor(public payload: { bookList: BookGroupModel[] }) { }
}
export class SearchBookErrorAction implements Action {
  readonly type = BookDetailsActionType.SEARCH_BOOK_ERROR;

  constructor() { }
}

export class SelectFilterAction implements Action {
  readonly type = BookDetailsActionType.SELECT_FILTER;

  constructor(public payload: { selectedFilter: string }) { }
}
